      ...
      <div className={`${robotoSlab.className} inline-flex flex-col justify-self-center border rounded p-12`}>
        ...
        <div className="inline-flex flex-col text-xl">
          <form method="POST" action={`/api/user`} onSubmit={submitForm}>
            ...
            <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:focus:ring-green-800">Submit</button>
          </form>
        </div>
      </div>
  );
